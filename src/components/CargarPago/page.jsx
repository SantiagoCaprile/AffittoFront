...
const CargarPago = ({ forzarUpdate }) => {
	const contratoId = document.location.pathname.split("/")[3];
	...
	const onSubmit = (data) => {
		...
		Contrato.pagarCelebracion(data, setEnvio);
		forzarUpdate(data.monto);
	};
					...
					<div className="flex items-center justify-between">
						{envio.loading ? (
							...
							<p className="text-red-500 italic text-center text-sm">
								No se pudo cargar el pago, intentelo mas tarde
							</p>
						) : (
							<button
